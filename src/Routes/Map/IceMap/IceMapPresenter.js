...
const TestContainer = styled.div`
  background-image: url("https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EB%B6%81%EA%B7%B9%EB%B0%B0%EA%B2%BD.jpg");
          ...
          {map.map((items) =>
            items.map((item) =>
              item === 1 ? (
                <FlameWrapper
                  src={
                    "https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EB%B9%99%ED%95%98.png"
                  }
                ></FlameWrapper>
              ) : item === 2 ? (
                <PillarWrapper
                ...
                <RoofWrapper
                  src={
                    "https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EC%95%84%EC%B9%98.png"
                  }
                ></RoofWrapper>
              ) : (
