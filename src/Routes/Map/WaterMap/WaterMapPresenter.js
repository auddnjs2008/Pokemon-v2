...
const WatherWrapper = styled.img`
  width: 100%;
  height: 100%;
  /* z-index:1;   */
...
const Trainer = styled.img`
  ...
  transform: ${(props) => (props.frontMove ? "translate(100%,5%)" : "")};
  z-index: 1;
`;
      ...
      <TestContainer>
        <MapContainer ref={yard}>
          {map.map((items) =>
            items.map((item) =>
              item === 1 ? (
                ...
                <WaveWrapper
                  src={
                    "https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%ED%8C%8C%EB%8F%84.png"
                  }
                ></WaveWrapper>
              )
            )
          ...
          <Ship
            frontMove={frontMove}
            src={
              "https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EB%B0%B0.png"
            }
            ref={char}
            position={charPosition}
            windowSize={windowSize}
