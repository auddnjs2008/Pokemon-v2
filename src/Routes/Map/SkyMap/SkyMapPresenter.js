...
const TestContainer = styled.div`
  background-image: url("https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%ED%95%98%EB%8A%98%EB%B0%B0%EA%B2%BD.jpg");
...
const Trainer = styled.img`
  ...
  transform: ${(props) =>
    props.frontMove ? "translate(50%,5%)" : "translate(-50%,0)"};
  z-index: 1;
`;
      ...
      <TestContainer>
        <MapContainer ref={yard}>
          ...
          <Airplane
            frontMove={frontMove}
            src={
              "https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EC%A2%85%EC%9D%B4%EB%B9%84%ED%96%89%EA%B8%B0.png"
            }
            ref={char}
            position={charPosition}
            windowSize={windowSize}
...
export default SkyMapPresenter;

SkyMapPresenter.propTypes = {
  map: PropTypes.array,
