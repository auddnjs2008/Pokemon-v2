...
const TestContainer = styled.div`
  background-image: url("https://usecloud.s3-ap-northeast-1.amazonaws.com/pokmonImages/%EC%A0%84%EA%B8%B0%EB%B0%B0%EA%B2%BD.jpg");
...
const ElectricWrapper = styled.img`
  width: 100%;
  height: 100%;
  object-fit: cover;
  border-radius: 50%;
...
export default ElectricPresenter;

ElectricPresenter.propTypes = {
  map: PropTypes.array,
