...
import { IAttackEffect } from "../types";
...
const AttackEffect: React.FC<IAttackEffect> = ({ type }) => {
        ...
        <>
          <div className="myAttack">
            ...
            <AttackBall
              color={
                type[0].length === 2
                  ? attackColor[type[0][1]]
                  : attackColor[type[0][0]]
              }
            ></AttackBall>
          </div>
          <div className="battleAttack">
            ...
            <AttackBall
              color={
                type[1].length === 2
                  ? attackColor[type[1][1]]
                  : attackColor[type[1][0]]
              }
            ></AttackBall>
          </div>
        </>
